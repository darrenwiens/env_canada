...
OBSERVATION_MESSAGE = '/air_quality/aqhi/{}/observation/realtime/xml/AQ_OBS_{}_CURRENT.xml'
...
class ECAQHI(object):
    ...
    def __init__(self,
        ...
        if aqhi_id is None:
            self.aqhi_id = self.closest_aqhi(float(coordinates[0]), float(coordinates[1]))
        else:
    ...
    def fetch_new_observation(self):
        ...
        aqhi_result = requests.get(AQHI_OBSERVATION_URL.format(self.aqhi_id[0], self.aqhi_id[1]),
                                   timeout=10)
    ...
    def fetch_new_forecast(self):
        ...
        aqhi_result = requests.get(AQHI_FORECAST_URL.format(self.aqhi_id[0], self.aqhi_id[1]),
                                   timeout=10)
    ...
    def get_aqhi_regions(self):
        ...
        for zone in xml_object.findall("./EC_administrativeZone"):
            ...
            for region in zone.findall("./regionList/region"):
                ...
                _region_attrib = {"region_name": _region_attribs[region_name_tag],
