...
class ECHydro(object):
    ...
    def fetch_new_data(self):
        ...
        hydro_csv_response = requests.get(
            READINGS_URL.format(prov=self.province, station=self.station), timeout=10
        )
    ...
    def get_hydro_sites():
        ...
        header = [
            h.split("/")[0].strip() for h in sites_csv_stream.readline().split(",")
        ]
